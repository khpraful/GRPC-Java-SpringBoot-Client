...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.emp.grpc.EmployeeOuterClass.Employee,
      com.emp.grpc.EmployeeOuterClass.EmployeeResponse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.emp.grpc.EmployeeOuterClass.Employee.class,
      responseType = com.emp.grpc.EmployeeOuterClass.EmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.emp.grpc.EmployeeOuterClass.Employee,
      com.emp.grpc.EmployeeOuterClass.EmployeeResponse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.emp.grpc.EmployeeOuterClass.Employee, com.emp.grpc.EmployeeOuterClass.EmployeeResponse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<com.emp.grpc.EmployeeOuterClass.Employee, com.emp.grpc.EmployeeOuterClass.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.emp.grpc.EmployeeOuterClass.Employee.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.emp.grpc.EmployeeOuterClass.EmployeeResponse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.emp.grpc.EmployeeOuterClass.Employee request,
        io.grpc.stub.StreamObserver<com.emp.grpc.EmployeeOuterClass.EmployeeResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.emp.grpc.EmployeeOuterClass.Employee,
                com.emp.grpc.EmployeeOuterClass.EmployeeResponse>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.emp.grpc.EmployeeOuterClass.EmployeeResponse getEmployee(com.emp.grpc.EmployeeOuterClass.Employee request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.emp.grpc.EmployeeOuterClass.EmployeeResponse> getEmployee(
        com.emp.grpc.EmployeeOuterClass.Employee request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.emp.grpc.EmployeeOuterClass.Employee) request,
              (io.grpc.stub.StreamObserver<com.emp.grpc.EmployeeOuterClass.EmployeeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.emp.grpc.EmployeeOuterClass.getDescriptor();
    }
